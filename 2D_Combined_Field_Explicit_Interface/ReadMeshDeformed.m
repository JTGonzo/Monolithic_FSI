...
InfNode1 = find(abs(Nodef(:,1)-4.978)<0.001 & Nodef(:,2)>=(-90) & Nodef(:,2)<=(-78.499));
InfNode2 = find(abs(Nodef(:,1)-4.988)<0.001 & Nodef(:,2)>=(-90) & Nodef(:,2)<=(-78.499));
