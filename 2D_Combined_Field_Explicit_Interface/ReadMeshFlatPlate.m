function ReadMeshFlatPlate()

clear all;
fileID = fopen('FPEle.txt');
...
save('./FlexPlate/DataFPF.mat','DF','NF','cF','iF','gamIF','gamF','ElemF','NodeF','InfNode');
save('./FlexPlate/DataFPS.mat','DS','NS','cS','iS','gamIS','gamS','ElemS','NodeS','InfNode');