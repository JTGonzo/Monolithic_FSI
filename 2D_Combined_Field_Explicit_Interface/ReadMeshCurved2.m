...
function ReadMeshCurved2()

clear all;
clc;
fileID = fopen('elements1.txt');
...
save('FlexPlate\DataF.mat','DF','NF','cF','iF','gamIF','gamF','ElemF','NodeF');
save('FlexPlate\DataS.mat','DS','NS','cS','iS','gamIS','gamS','ElemS','NodeS');
