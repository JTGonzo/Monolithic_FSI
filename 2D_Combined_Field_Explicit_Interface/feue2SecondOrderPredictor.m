function etat=feue2SecondOrderPredictor(ALE,DeEF,ElemF,ElemS,Phy,Sol,meshString)
% u-eta formulation
...
% eta is displacement
eta=Sol.eta(:,:,1)+Sol.delt*(Sol.etat(:,:,1));
...
gg=Phy.g*[sin(Phy.theta),-cos(Phy.theta)];
bs=sM*Sol.etat(:,:,1)+GM.sM*(repmat(Sol.delt*gg,ElemS.nDof,1)); % sM contains rho

switch Sol.SVK
    case 0
        bs=bs(:)-GM.sL*eta(:); % sL contains delt
    case 1
