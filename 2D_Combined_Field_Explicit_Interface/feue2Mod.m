function [DeEF,Sol]=feue2Mod(ALE,DeEF,ElemF,ElemS,Phy,Sol,meshString)
% u-eta formulation
...
etat = feue2Predictor(ALE,DeEF,ElemF,ElemS,Phy,Sol,meshString);
...
switch Sol.SVK
    ...
    case 1
        [S,bsvk]=initMatrixSVK(ElemS,Phy,eta);
        zero1=sparse(ElemS.nDof,ElemS.nDof);
...
newEta = oldEta+Sol.delt*etat(:,:,1);

error = newEta(1:10,:)-eta(1:10,:)
