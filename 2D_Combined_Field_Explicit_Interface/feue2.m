function [DeEF,Sol]=feue2(ALE,DeEF,ElemF,ElemS,Phy,Sol,meshString)
% u-eta formulation
...
% fluid forcing term
gg=0*[sin(Phy.theta),-cos(Phy.theta)];
...
DeESN = deformedMeshData(ElemS.dof+Sol.eta,ElemS); % used for linear elasticity part
...
gg=0*[sin(Phy.theta),-cos(Phy.theta)];
bs=Sol.sMU+GM.sM*(repmat(Sol.delt*gg,ElemS.nDof,1)); % sM contains rho
